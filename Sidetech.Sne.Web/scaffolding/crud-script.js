...
prompt.get(schema, function (err, input) {
    ...
    var pathDestino = pathOrigem.replace(path.join('scaffolding/source'),
        path.join('ClientApp/app/components/' + modulo));
    ...
    console.log('#');
    console.log('## Adicione as seguintes linhas no arquivo ClientApp/app/components/app-routing.module.ts');
    console.log('#   import { ' + moduloCap + 'Routes } from \'./' + modulo + '\';');
    console.log('#   ...' + moduloCap + 'Routes');
    console.log('#');
    console.log('## Importe o módulo no arquivo ClientApp/app/components/app.module.ts');
